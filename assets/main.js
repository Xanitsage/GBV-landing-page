/* Main Generalized Active Simple Motion Liquid-JS Functions, I must avoid distructive JS and weird letency.| Unmask The Pain Using Js - PC and Mobile Xanitsage by Timothy Aaron Banda - License: MIT */
...
(function() {
		...
		(function() {
			...
			var initialSection, initialScrollPoint, initialId,
				...
				doNextScrollPoint = function(event) {
					...
					// Some Redirects will not work 'cause there is no extra backend python or php for server-side logic.
	...
	// Browser hacks.
		...
		// iOS.
				...
				// For some reason, simply forcing GPU acceleration on the background pseudoelement fixes this, run the browser at high perfomance, especially chrome and microsoft edge.
				...
				// Step through selected elements.
					$$(selector).forEach(function(e) {
						...
						// Initial rewind.
							...
							// Children sequence metaphor? Rewind each individually.
								if (children)
						...
						// Determine trigger element.
							...
							// Has a parent sequence metaphor?
								if (e.parentNode) {
	...
	// Initialize background.
		(function() {
			...
			new slideshowBackground('bg', {
				...
				images: [
					{
						src: 'assets/images/bg-8e3969af.jpg',
						position: 'center',
						motion: 'left',
						speed: 2,
						caption: 'P1',
					...
					{
						src: 'assets/images/bg-fdb01611.jpg',
						position: 'center',
						motion: 'right',
						speed: 2,
						caption: 'P2',
	...
	// Initialize "On Visible" animations.
		onvisible.add('.image.style1', { style: 'fade-right', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		...
		onvisible.add('h1.style4, h2.style4, h3.style4, p.style4', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('.buttons.style2', { style: 'fade-down', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		...
		onvisible.add('.buttons.style1', { style: 'fade-down', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('.image.style2', { style: 'fade-left', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('.icons.style1', { style: 'fade-down', speed: 500, intensity: 4, threshold: 3, delay: 0, stagger: 125, staggerSelector: ':scope > li', replay: false });
		onvisible.add('h1.style1, h2.style1, h3.style1, p.style1', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
